...
TODO: function to remove trailing whitespace
...
cmp.setup{
  ...
  sources = {
    ...
    -- { name = "ultisnips" }, -- I don't want the snippets in my auto completion
    { name = 'buffer' },
    { name = 'path' },
  },
...
cmp.setup.filetype('tex', {
  sources = {
    ...
    { name = 'nvim_lsp_signature_help' },
    -- { name = 'ultisnips' },
    { name = 'buffer', trigger_characters = {'\\'}, keyword_length = 100},
    { name = 'path' },
  },
})
-- cmp.setup {
